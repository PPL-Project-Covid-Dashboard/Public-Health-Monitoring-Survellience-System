...
def map_selection(data,selected_rows,graph_line):
    ...
    if len(selected_rows) == 0:
        fig1 = draw_singleState_Scatter(df_daily_confirmed,df_daily_deceased,df_daily_recovered,temp_df['State'],0)
        fig2 = draw_singleState_Bar(df_daily_confirmed,df_daily_deceased,df_daily_recovered,temp_df['State'],0,graph_line)
        return gen_map(aux, zoom, 19.663280,75.300293), fig1,fig2
    else:
        zoom = 4
        ...
        fig1 = draw_singleState_Scatter(df_daily_confirmed,df_daily_deceased,df_daily_recovered,temp_df['State'],selected_rows[0])
        fig2 = draw_singleState_Bar(df_daily_confirmed,df_daily_deceased,df_daily_recovered,temp_df['State'],selected_rows[0],graph_line)
